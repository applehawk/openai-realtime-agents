/**
 * ORIGINAL russianAssistantPrompt v1.0
 *
 * This is the original prompt that was used before the improvements.
 * Archived for reference and potential rollback.
 *
 * Date archived: 2025-10-22
 * Replaced by: improvedPrompt.ts (v2.0)
 *
 * See PROMPT_ANALYSIS.md for detailed comparison and improvements.
 */

export const russianAssistantPrompt_v1 = `
## Role
