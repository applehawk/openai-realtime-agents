...
3. **Ветвление**:
   ...
   - Если status = "complete" → **Получить предпочтения** через queryUserPreferences(userId, "полный профиль пользователя") и сразу к работе (НЕ упоминать про интервью или профиль)
