...
3. Это запрос про веб-исследование/рисерч/внешние источники? → ДА → Path 4: Intelligent Supervisor ⭐
...
4. Это вопрос о прошлом/истории/внутренних документах? → ДА → Path 2: Knowledge Agent (handoff)
   - После возврата от Knowledge Agent:
     - Если информация найдена → продолжить разговор
